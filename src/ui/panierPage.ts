import { PanierService } from '../services/PanierService'; // Corrigez le chemin si nécessaire
import { ArticlePanier } from '../models/ArticlePanier'; // Corrigez le chemin si nécessaire
